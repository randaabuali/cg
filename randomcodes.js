...
function makecode(numofchars,isuppercase) {
  ...
  var newnum = numofchars-1;
  var randomlength=Math.floor(Math.random()*(newnum)+1); //random number of alphabets in the code
  if (isuppercase) {
...
function codeGenerator() {
  ...
  if(!numofchars || numofchars <5 || numofchars> 10) {
    numofchars=7;
